...
function App() {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { style: { height: "100%", width: "100%", display: "block" } }, /*#__PURE__*/
    ...
    React.createElement("div", { style: divStyle }, /*#__PURE__*/
    React.createElement("button", { onClick: () => prevCard(), style: prevStyle }, "Previous Card"), /*#__PURE__*/


    React.createElement("button", { onClick: () => setFlipped(!flipped), style: flipStyle },
    flipped ? "Flip to back" : "Flip to front"), /*#__PURE__*/

    React.createElement("button", { onClick: () => nextCard(), style: nextStyle, }, "Next Card")), /*#__PURE__*/



    React.createElement("div", { className: "menu__container" }, /*#__PURE__*/
    React.createElement("div", { className: "card__menu" }, /*#__PURE__*/
    ...
    React.createElement(AddCard, {
      ...
      totalCards:
      filtered ? activeCards.length + filteredCards.length : deck.length })), /*#__PURE__*/



    React.createElement("br", null), /*#__PURE__*/
    React.createElement("div", { className: "save__load" }, /*#__PURE__*/
    React.createElement("button", {
    ...
    React.createElement(SaveLoad, {
      ...
      sendInputStatus: getChildInputStatus,
      activeDeck: filtered ? activeCards : deck })), /*#__PURE__*/


    React.createElement("br", null), /*#__PURE__*/
    React.createElement("div", { className: filterCardsClass }, /*#__PURE__*/
    React.createElement("button", { onClick: () => setShowFilterMenu(!showFilterMenu) },
    ...
    React.createElement(FilterCardsMenu, {
      ...
      deck: deck,
      sendUpdatedDeck: getUpdatedDeck }))), /*#__PURE__*/




    React.createElement("div", { className: "shuffle__deck" }, /*#__PURE__*/
    React.createElement("button", {
      ...
      } }, "Shuffle Deck"))), /*#__PURE__*/





    React.createElement("div", { className: "delete__deck" }, /*#__PURE__*/
    React.createElement("button", {
    ...
    React.createElement("div", { className: "filter__status__container" }, /*#__PURE__*/
    React.createElement("div", { className: filtered ? "filter__status" : "display-none" },
...
const Card = props => {
  ...
  return (
    ...
    React.createElement("div", { className: props.flipped ? "back noselect expand" : "back noselect collapse" }, data ? data.back : ""))) : /*#__PURE__*/
    ...
    React.createElement("div", { style: stringStyle }, /*#__PURE__*/React.createElement("pre", null, /*#__PURE__*/React.createElement("code", null,
    stringTemp()))), /*#__PURE__*/
...
function SaveLoad(props, { sendLoadCallback }) {
  ...
  const showCheckOrX = (showSpinner, loadInfo) => {
    if (!showSpinner && loadInfo == "Couldn't find any card-like objects!") {
      return /*#__PURE__*/React.createElement(React.Fragment, null, "\u274C");} else if (!showSpinner && strings.includes(loadInfo, "Success")) {
  ...
  // };
  return /*#__PURE__*/(
    React.createElement("form", { className: display, onSubmit: handleSubmit }, /*#__PURE__*/
    React.createElement("input", {
      type: "radio",
      name: "save",
      checked: action === "save",
      onChange: handleOptsChange }), /*#__PURE__*/

    React.createElement("label", { htmlFor: "save" }, "Save"), /*#__PURE__*/
    React.createElement("input", {
      type: "radio",
      name: "add",
      checked: action === "add",
    ...
    React.createElement("label", { htmlFor: "load" }, "Load (Add)"), /*#__PURE__*/
    React.createElement("input", {
      type: "radio",
      name: "replace",
    ...
    React.createElement("label", { htmlFor: "replace" }, "Load (Replace)"), /*#__PURE__*/
    React.createElement("br", null), /*#__PURE__*/

    React.createElement("label", { htmlFor: "filename", className: "save-load-label" },
    labelContents), /*#__PURE__*/

    React.createElement("br", null), /*#__PURE__*/
    React.createElement("div", { className: "filename__input__container" }, /*#__PURE__*/
    React.createElement("input", {
      type: "text",
      name: "filename",
      ...
      onBlur: () => props.sendInputStatus(false) })), /*#__PURE__*/


    React.createElement("div", { className: "text__or__file__button__container" }, /*#__PURE__*/
    React.createElement("button", {
      onClick: e => {
    ...
    textAreaOptionActive ? "Upload with File" : "Upload with TextArea")), /*#__PURE__*/
    ...
    React.createElement("div", {
      ...
      action !== "save" && textAreaOptionActive ?
      "validation__msg" :
      "display-none" }, /*#__PURE__*/


    React.createElement("div", { className: "check__or__x" },
    !showSpinner && loadInfo.includes("Couldn't") ? /*#__PURE__*/React.createElement(React.Fragment, null, "\u274C") : !showSpinner && loadInfo.toLowerCase().includes("found") ? /*#__PURE__*/React.createElement(React.Fragment, null, "\u2705") : /*#__PURE__*/React.createElement(React.Fragment, null)), /*#__PURE__*/
    ...
    React.createElement("div", { className: "lds-spinner" }, /*#__PURE__*/
    React.createElement("div", null), /*#__PURE__*/
    React.createElement("div", null), /*#__PURE__*/
    React.createElement("div", null), /*#__PURE__*/
    React.createElement("div", null), /*#__PURE__*/
    ...
    React.createElement("div", { className: "validation__txt" },
    showSpinner ? "Validating json..." : loadInfo), /*#__PURE__*/

    React.createElement("input", { type: "submit", value: buttonVal, onFocus: handleFocus })));
...
const FilterCardsMenu = props => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: showOrHide }, /*#__PURE__*/
    React.createElement("button", { onClick: () => setFilterActive(!filterActive) },
    filterActive ? "Disable Filter" : "Enable Filter"), /*#__PURE__*/

    React.createElement("div", { className: "card__select" }, /*#__PURE__*/
    React.createElement("ul", { className: "active__cards__filter" },
    activeCards.map((card) => /*#__PURE__*/
    React.createElement("li", { key: card.id }, /*#__PURE__*/
    React.createElement("input", {
      name: card.id,
      type: "checkbox",
      checked: card.active,
    ...
    React.createElement("div", { className: "active__card" },
    " ",
    card.front, " / ", card.back, ", id: ", card.id, " ")))), /*#__PURE__*/




    React.createElement("ul", { className: "inactive__cards__filter" },
    filteredCards.map((card) => /*#__PURE__*/
    React.createElement("li", { key: card.id }, /*#__PURE__*/
    React.createElement("input", {
      name: card.id,
      type: "checkbox",
    ...
    React.createElement("div", { className: "inactive__card" },
    card.front, " / ", card.back, ", id: ", card.id, " ")))), /*#__PURE__*/




    React.createElement("div", { className: "reset__filter__div" }, /*#__PURE__*/
    React.createElement("button", { className: "reset__filter__button", onClick: resetFilter }, "Reset Filter", /*#__PURE__*/
    React.createElement("br", null), "(activates all cards)")))));
...
const AddCard = props => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("input", {
      ...
      onChange: handleEditOrAddChange }), /*#__PURE__*/
    ...
    React.createElement("input", { type: "button", value: buttonVal, onClick: handleSubmit }))));
